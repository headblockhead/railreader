    ...
    sftp = {
      ...
      privateHostKeyFile = lib.mkOption {
        ...
        description = ''
          ...
          If null, a new keypair will be autogenerated on first run.
      ...
      config = lib.mkIf cfg.enable {
        ...
        systemd.services.railreader-ingest = let ingcfg = cfg.ingest; in {
          ...
          environment = {
            ...
            DARWIN_KAFKA_USERNAME = ingcfg.darwin.kafka.username;
          ...
          serviceConfig = {
            ...
            '';
            LoadCredential = "darwinKafkaPassword:${cfg.ingest.darwin.kafka.passwordFile}";
          };
        };
